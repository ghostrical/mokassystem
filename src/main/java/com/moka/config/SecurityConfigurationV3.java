...
// getSharedObject()를 통해서 Spring Security의 설정을 구성하는 SecurityConfigurer 간에 공유되는 객체를 얻을 수 있습니다.
            ...
            jwtAuthenticationFilter.setAuthenticationSuccessHandler(new PersnlAuthenticationSuccessHandler());  // (3) 추가
            jwtAuthenticationFilter.setAuthenticationFailureHandler(new PersnlAuthenticationFailureHandler());  // (4) 추가
